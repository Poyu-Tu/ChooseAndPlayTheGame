from django.shortcuts import render # render 函式用於渲染模板，渲染模板是將動態生成的內容（如從數據庫中查詢得到的資料）通過渲染模板的過程嵌入到這些模板中，最終生成完整的 HTML 頁面
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if member.password == password:
                ...
                return JsonResponse({'success': True, 'message': '登入成功！', 'welcome_message': welcome_message, 'redirect': 'https://www.youtube.com/'})
